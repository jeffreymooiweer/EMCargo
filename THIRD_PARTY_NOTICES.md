...
| Cal Sans | [Cal Sans](https://github.com/calcom/font), SIL Open Font License 1.1 | Preserve `frontend/public/fonts/cal-sans-LICENSE.txt` and `backend/app/assets/fonts/CalSans-LICENSE.txt`; the font is also embedded in generated PDFs and is not relicensed by the application |
| DejaVu Sans 2.37 (regular and bold) | [DejaVu fonts](https://dejavu-fonts.github.io/License.html), Bitstream Vera and Arev font terms; DejaVu changes are public domain | Unmodified font files embedded in generated PDFs; preserve `backend/app/assets/fonts/DejaVu-LICENSE.txt`. Card packages include both font licenses |
